...
import mil.nga.giat.geowave.core.ingest.hdfs.mapreduce.hbase.IngestFromHBaseHdfsPlugin;
 ...
 */
public interface IngestFormatPluginHBaseProviderSpi<I, O>
{
	/**
	 ...
	 */
	public IngestFromHBaseHdfsPlugin<I, O> getIngestFromHdfsPlugin()
			throws UnsupportedOperationException;

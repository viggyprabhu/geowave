...
public abstract class DataStoreFactory
{
	...
	public abstract StoreOperations getStoreOperations(
			String zookeeperURL,
			String instanceName,
			String userName,
			String password,
	...
	public abstract IndexStore getIndexStore(
	...
	public abstract DataStatisticsStore getAccumuloDataStatisticsStore(
			StoreOperations accumuloOperations );

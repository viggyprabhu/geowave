...
public class GeoWaveCoreConfiguratorBase
{
	...
	public static void setAccumuloOperationsInfo(
		...
		GeoWaveCoreConfiguratorBase.setZookeeperUrl(
				scope,
				config,
				zooKeepers);
		GeoWaveCoreConfiguratorBase.setInstanceName(
				scope,
				config,
				instanceName);
		GeoWaveCoreConfiguratorBase.setUserName(
				scope,
				config,
				userName);
		GeoWaveCoreConfiguratorBase.setPassword(
				scope,
				config,
				password);
		GeoWaveCoreConfiguratorBase.setTableNamespace(
				scope,
				config,

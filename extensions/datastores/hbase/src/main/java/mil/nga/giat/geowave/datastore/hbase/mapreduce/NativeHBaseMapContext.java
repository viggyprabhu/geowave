...
{
	private final MapContext<KEYIN, VALUEIN, GeoWaveHBaseInputKey, ObjectWritable> context;
	private final HBaseHadoopWritableSerializationTool serializationTool;

	public NativeHBaseMapContext(
			final MapContext<KEYIN, VALUEIN, GeoWaveHBaseInputKey, ObjectWritable> context,
			final AdapterStore adapterStore ) {
		this.context = context;
		this.serializationTool = new HBaseHadoopWritableSerializationTool(
				adapterStore);
	}

	public NativeHBaseMapContext(
			final MapContext<KEYIN, VALUEIN, GeoWaveHBaseInputKey, ObjectWritable> context,
			final HBaseHadoopWritableSerializationTool serializationTool ) {
		this.context = context;

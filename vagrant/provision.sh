...
/usr/local/maven/bin/mvn clean package -pl geowave-deploy -am -P benchmark-singlejar -DskipITs=true -DskipTests=true

# Install GeoWave service
echo "GeoWave: Installing Service..."
sudo cp /home/vagrant/geowave/vagrant/geowave /etc/init.d
